...
class AccountActivationConfirmationPage extends React.Component<Props, State> {
  ...
  componentWillReceiveProps(nextProps: Props): void {
    if (nextProps.user.token.updatedAt !== this.props.user.token.updatedAt) {
      ...
      this.props.userMethods.confirmAccountActivation(this.props.match.params.token);
    }
  }
...
export default withRedirectionIfAuthenticated(withRouter(
  connect(mapStateToProps, mapDispatchToProps)(AccountActivationConfirmationPage),
));
